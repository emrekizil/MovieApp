...
class SearchPagingAdapter :
    PagingDataAdapter<Movie, SearchPagingAdapter.SearchViewHolder>(MovieDiffCallback()) {
    class SearchViewHolder(private val binding: ItemMovieGridBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: Movie?) {
