...
import com.emrekizil.feature_home.databinding.FragmentHomeBinding
import com.emrekizil.feature_search.SearchPagingAdapter
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.layoutPreference.collect { isGridManager ->
                    ...
                    if (isGridManager) {
                        ...
                        binding.layoutManagerButton.setImageResource(com.emrekizil.core_ui.R.drawable.icon_grid_layout)
                    } else {
                        binding.recyclerView.layoutManager = LinearLayoutManager(context)
                        adapter.setGridMode(false)
                        binding.layoutManagerButton.setImageResource(com.emrekizil.core_ui.R.drawable.icon_linear_layout)
                    }
        ...
        lifecycleScope.launch {
            searchAdapter.loadStateFlow.collectLatest { loadStates->
                if (loadStates.refresh is LoadState.Error && binding.searchView.editText.isShown) {
                    showSnackbar(getString(com.emrekizil.core_ui.R.string.something_went_wrong),null,null)
                }
