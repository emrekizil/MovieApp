...
class DetailFragment : BaseFragment<FragmentDetailBinding>(FragmentDetailBinding::inflate) {
    ...
    private fun setUi(data: MovieUiState) {
        with(binding) {
            ...
            favoriteButton.setImageResource(if (data.isFavorite) com.emrekizil.core_ui.R.drawable.icon_delete_favorite else com.emrekizil.core_ui.R.drawable.icon_add_favorite)
        }
    }
